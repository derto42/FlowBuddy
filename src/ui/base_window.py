...
class MainLayer(QWidget):
    ...
    def paintEvent(self, a0: QPaintEvent) -> None:
        ...
        path = QPainterPath()
        path.addRoundedRect(
            QRectF(self.rect()), CORNER_RADIUS * UI_SCALE, CORNER_RADIUS * UI_SCALE
        )
...
class InnerPart(QWidget):
    def __init__(self, add_tab: bool = False, parent: BaseWindow = None) -> None:
        super().__init__(parent)
        ...
        if add_tab:
            ...
            title_layout.setContentsMargins(
                0, int(10 * UI_SCALE), 0, int(10 * UI_SCALE)
            )
    ...
    def mouseMoveEvent(self, a0: QMouseEvent) -> None:
        if self._parent._offset is not None and a0.buttons() == Qt.LeftButton:
            margin_offset = QPoint(
                self._parent._margin_for_shadow, self._parent._margin_for_shadow
            )
...
class BaseWindow(QWidget):
    def __init__(self, add_tab: bool = False, parent: QWidget | None = None) -> None:
